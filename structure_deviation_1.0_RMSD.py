#calculate the structure deviation between unrelax and relax structure by RMSE
...
for i in all_xyz:
    ...
    for line1 in file1.readlines()[2:28]:
        part1 = line1.split()
        x1 = float(part1[1])
        y1 = float(part1[2])
        z1 = float(part1[3])
    ...
    for line2 in file2.readlines()[2:28]:
        part2 = line2.split()
        x2 = float(part2[1])
        y2 = float(part2[2])
        z2 = float(part2[3])
